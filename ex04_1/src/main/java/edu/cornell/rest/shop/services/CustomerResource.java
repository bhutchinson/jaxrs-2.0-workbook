package edu.cornell.rest.shop.services;

import edu.cornell.rest.shop.domain.Customer;
...
public class CustomerResource
{
   ...
   public Response createCustomer(InputStream is)
   {
      ...
      return Response.created(URI.create("/services/customers/" + customer.getId())).build();
